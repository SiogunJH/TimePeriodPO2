...
namespace TimePeriodExtendedUnitTests
{
    [TestClass]
    public class TimePeriodExtendedUnitTests
    {
        ...
        {
            new TimePeriod(null, null, null, null);
        }
        ...
        {
            var t1 = new TimePeriod(h1, m1, s1, ms1);
            var t2 = new TimePeriod(h2, m2, s2, ms2);
        ...
        [DataRow(23, 59, 59, 999, 0, 0, 0, 1, 24, 0, 0, 0)]
        ...
        public void Operator_Add(int h1, int m1, int s1, int ms1, int h2, int m2, int s2, int ms2, int h3, int m3, int s3, int ms3)
        {
            ...
            var t2 = new TimePeriod(h3, m3, s3, ms3);
